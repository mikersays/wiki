...
| Challenge | Detail |
|-----------|--------|
| Staffing | Deputy director position remains vacant as of February 2026 |
| Reporting | 2025 annual report not published despite statutory requirement |
| Data quality | Half of all cases lack sufficient data for meaningful investigation |
| Overclassification | FY2026 NDAA requires AARO to account for classification practices ([[ndaa-uap-provisions]]) |
...
- The [[ndaa-uap-provisions|FY2026 NDAA]] mandates AARO brief Congress on all UAP intercepts by [[norad]] and [[usnorthcom]] since 2004
...
In Release 02 ([[src-newsweek-pursue-release-02-2026-05]]), AARO is identified as the entity that **assembled the released Pentagon footage of the 2023 [[lake-huron-shootdown-2023|Lake Huron shootdown]]** in response to lawmaker requests, and **flagged a 2022 submarine-vicinity transmedium-sphere clip** for further analysis. Per [[avi-loeb]]'s May 11, 2026 *The Hill's Rising* interview ([[src-loeb-two-ufo-interpretations-2026-05]]), the [[galileo-project]] is in **active communication with AARO** — first explicit confirmation in the vault of civilian-research-team coordination with the office.

The DoW primary-source Release 02 press release ([[src-dow-pursue-release-02-2026-05]]) names AARO as the entity that **identified the responsive materials** for the **March 6, 2026 eight-House-Rep letter** requesting 51 UAP-related records — a separate and earlier congressional pressure track from Luna's March 31 46-video letter. AARO authored the sensor-faithful "areas of contrast" descriptions for individual video records, codifying the [[mick-west]]/Metabunk-terminology register in government-spoken language.
