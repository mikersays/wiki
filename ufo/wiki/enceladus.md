...
- **South polar [[enceladus-plumes|plumes]]** — water-ice geysers erupting from "tiger stripe" fractures, observed by [[cassini-huygens|Cassini]] from 2005 onward.
...
- **Magnetospheric mass-loading** — Enceladus-supplied plasma reshapes [[saturn-magnetosphere|Saturn's magnetosphere]], producing an afternoon-shifted magnetic cusp (Xu et al. 2026, *Nature Communications*). ([[src-cassini-huygens-ocean-worlds-2026-04]])
